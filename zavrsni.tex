...
\begin{enumerate}
    ...
    \item bit prijenosa u binarnom zbrajalu
\end{enumerate}
...
\begin{figure}
    ...
    \begin{subfigure}{0.46\textwidth}
        \centering
        \includegraphics[width=\textwidth]{img/37muxre.pdf}
        \caption{Početno stanje igre. Igrači kreću na suprotnim stranama s 12 pijuna.}
        \label{fig:starting_state}
    \end{subfigure}
    \hspace{0.05\textwidth}
    \begin{subfigure}{0.46\textwidth}
        \centering
        \includegraphics[width=\textwidth]{img/6muxre.pdf}
        \caption{Bijeli je na potezu i mora preskakati s figurom na polju 18.}
        \label{fig:game_state}
    \end{subfigure}
    \caption{Primjeri stanja igre}
    \label{fig:states}
\end{figure}
