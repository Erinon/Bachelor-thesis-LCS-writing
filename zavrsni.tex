...
Prilikom istraživanja novih pravila koriste se tehnike evolucijskog računarstva \engl{evolutionary computation}.

Položaj \emph{evolucijskog računarstva} unutar \emph{računarstva} prikazan je slikom \ref{img:racpol}.
\emph{Evolucijsko računarstvo} jedna je od grana \emph{računarstva} iz skupine \emph{mekog računarstva} \engl{soft computing}, zajedno sa \emph{neuro-računarstvom} i \emph{neizrazitim računarstvom}.
...
Više informacija o evolucijskom računarstvu i genetskim algoritmima čitatelj može pronaći u \citep{6}.
\begin{figure}[!h]
    \centering
    \includegraphics[width=\textwidth]{img/racpol.pdf}
    \caption{Položaj evolucijskog računarstva unutar računarstva.}
    \label{img:racpol}
\end{figure}
...
Ažuriranje tih parametara obavlja se tehnikama potpornog učenja \engl{reinforcement learning}, koje usmjerava potragu za boljim pravilima \citep{3}.
...
\begin{figure}[!h]
    ...
    \label{img:racpol}
\end{figure}
\emph{Podržano učenje} grana je \emph{strojnog učenja} \engl{machine learning} zajedno za \emph{nadziranim} \engl{supervised} i \emph{nenadziranim učenjem} \engl{unsupervised learning}.
Podržano učenje je na pokušajima, nakon kojih sustav dobije određenu brojčanu nagradu.
...
Značajka podržanog učenja je da se sustav ne uči na poznatim točnim ishodima, nego sustav sam odabire svoju akciju na temelju koje dobiva određenu brojčanu nagradu.
Na taj način je sustav primoran učiti samo iz svog prethodnog iskustva.
Detaljniju analizu podržanog učenja čitatelj može pronaći u \citep{7}.
...
Jedna jedinka je cijeli skup pravila, što znači da je karakteristika \emph{pittsburgskog stil} da sadrži više neovisnih skupova pravila.
Iako pravila moraju biti jednake duljine, svaki skup pravila može sadržavati različit broj pravila.
Genetski algoritam pokreće se nad cijelim skupom jedinki, odnosno na skupom skupova pravila.

U okviru ovog rada obrađen je \emph{michiganski stil} sustava LCS.
\emph{michiganski stil} sustava LCS
\emph{michiganski stil} sustava LCS prvi je formalizirao John Holland i u suradnji s Judith Reitman dao njegovu implementaciju.
...
Nakon ažuriranja parametara, ako je zadovoljen određeni uvjet, uključuje se istraživačka komponenta koja primjenom genetskih algoritama istražuje nova pravila.
Operacija istraživanja novih parametara djeluje isključivo nad akcijskim skupom.
...
Ako je broj pojavljivanja bita 1 paran, broj se treba proširiti bitom 0, a u suprotnom bitom 1.
...
Ulazni broj ima 4 bita i 3 bita 0.
